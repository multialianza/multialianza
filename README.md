...
- Aprendiendo desarrollo full-stack
   ...
   🔭 Actualmente trabajo en proyectos de desarrollo de software utilizando JavaScript, Node.js y PostgreSQL.

  🧠 Interesado en Ciberseguridad y Alfabetización Digital

  🌱 Aprende más sobre el desarrollo full-stack y los sistemas de datos.

  🎯 Mi objetivo es crear tecnología que ayude a las personas a comprender y utilizar el mundo digital de forma segura.
